...
@Component({
  selector: 'app-example-highcharts',
  templateUrl: './example-highcharts.component.html',
  styleUrls: ['./example-highcharts.component.css']
})
export class ExampleHighchartsComponent implements AfterViewInit {
